...
/**
 * Test the {@link CountingInversionsOptimized} class.
 */
@SpringBootTest
public class CountingInversionsOptimizedTest {

    @Test
    public void zeroInversionsCountTest() {
        int[] arr = {1, 1, 1, 2, 2};
        long inversions = CountingInversionsOptimized.countInversions(arr);
